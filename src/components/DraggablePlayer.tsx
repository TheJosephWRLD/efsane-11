...
export default function DraggablePlayer({ player }: DraggablePlayerProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className={`player-card relative grid min-h-11 grid-cols-[3rem_1fr_auto_2.4rem] items-center gap-2 border-b border-black/25 px-3 py-2 transition-all cursor-pointer select-none
